...
import static io.github.stekeblad.mytodoapp.resources.Constants.INTENT_EDIT;
...
public class AddEditActivity extends DaggerAppCompatActivity implements AddEditContract.View{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textHeader = findViewById(R.id.NewTodoHeader);
        textDesc = findViewById(R.id.NewTodoDescription);
    ...
    public void onClickSave(View view) {
        ...
        if (addEdit_flag == INTENT_EDIT) {
            ...
            // to ignoring instead of saving a new to-do
